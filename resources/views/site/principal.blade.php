...
<body>
    ...
    <div class="login aligntext-right">
    <a href="/">Login</a>
...
<p>Esses são os cursos que oferemos:</p>
<ul>
    <li>Administração</li>
    <p>É o profissional que analisa e projeta sistemas. Constrói, docuemnta, e realiza produção de sistemas e páginas web.</p>
    <li>Contabilidade</li>
